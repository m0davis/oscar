...
```agda
module Type.deprecated.Term.Layer-1 where
...
```agda
-- open import Type.deprecated.Term.Layer-1.Kernel public
...
private
  ...
  module Test where
    ...
    module _ where
      open import Type.deprecated.Term.Layer-1.Kernel myMeta

      testExpression₁ : Expression 0
      testExpression₁ = 𝓉 0 (𝒰 0 ∷ 𝓋 0 ∷ [])

    module _ where
      open import Type.deprecated.Term.Layer-1.Kernel
...
open import Type.deprecated.Term.Layer-1.Kernel alphabet public
module K = Type.deprecated.Term.Layer-1.Kernel
...
```agda
import Type.deprecated.Term.Layer-1.SCTerm
```
