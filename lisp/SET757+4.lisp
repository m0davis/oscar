...
justification = 1.0
      (all A)(all B)(all x)((mem x (int A B)) <-> ((mem x A) & (mem x 
B)))    justification = 1.0
      (all A)(all B)((maps F A B) <-> ((all x)((mem x A) -> (some 
y)((mem y B) & (F x y))) & (all x)(all y)(all z)(((mem x A) & ((mem y 
A) & (mem z A))) -> (((F x y) & (F x z)) -> (= y z))))) 
justification = 1.0
      (all A)(all x)(all y)((= x y) -> ((mem x A) -> (mem y A))) 
justification = 1.0
      (all A)(all B)((equal A B) <-> ((subset A B) & (subset B A))) 
justification = 1.0
      (all B)(all A)(all b1)(all x)((mem x (inv F b1 A)) <-> ((mem x 
A) & (some y)((mem y b1) & (F x y))))    justification = 1.0
Ultimate epistemic interests:
      (all A)(all B)(all X)(all Y)(((maps F A B) & ((subset X B) & 
...
10.  (all B)((equal x4 B) <-> ((subset x4 B) & (subset B x4)))     UI 
from { 5 }
12.  ((equal x4 x6) <-> ((subset x4 x6) & (subset x6 x4)))     UI from { 10 }
19.  (((subset x4 x6) & (subset x6 x4)) -> (equal x4 x6)) 
bicondit-simp from { 12 }
18.  ((equal x4 x6) -> ((subset x4 x6) & (subset x6 x4))) 
bicondit-simp from { 12 }
20.  ((subset x4 x6) -> ((subset x6 x4) -> (equal x4 x6))) 
exportation from { 19 }
1.  (all A)(all B)((subset A B) <-> (all x)((mem x A) -> (mem x B)))     given
8.  (all B)((subset x2 B) <-> (all x)((mem x x2) -> (mem x B))) 
UI from { 1 }
11.  ((subset x2 x5) <-> (all x)((mem x x2) -> (mem x x5)))     UI from { 8 }
14.  ((subset x2 x5) -> (all x)((mem x x2) -> (mem x x5))) 
bicondit-simp from { 11 }
15.  ((all x)((mem x x2) -> (mem x x5)) -> (subset x2 x5)) 
bicondit-simp from { 11 }
16.  (some z8)(((mem z8 x2) -> (mem z8 x5)) -> (subset x2 x5)) 
A-removal from { 15 }
17.  (((mem (@y9 x2 x5) x2) -> (mem (@y9 x2 x5) x5)) -> (subset x2 
x5))     EI from { 16 }
46.  (~(mem (@y9 x2 x5) x2) -> (subset x2 x5)) 
cond-antecedent-simp from { 17 }
47.  ((mem (@y9 x2 x5) x5) -> (subset x2 x5)) 
cond-antecedent-simp from { 17 }
531.  ~(equal x596 ^x18) supposing { ~(equal x596 ^x18) } 
reductio-supposition
45.  ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0))) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv 
F ^x18 ^x0) (inv F ^x19 ^x0))) }     reductio-supposition
75.  ~((subset (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv 
F ^x19 ^x0))) & (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv 
F (int ^x18 ^x19) ^x0))) supposing { ~(equal (inv F (int ^x18 ^x19) 
^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     modus-tollens2 
from { 19 , 45 }
76.  (~(subset (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv 
F ^x19 ^x0))) v ~(subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv 
F (int ^x18 ^x19) ^x0))) supposing { ~(equal (inv F (int ^x18 ^x19) 
^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     DM from { 75 }
77.  ((subset (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv 
F ^x19 ^x0))) -> ~(subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) 
(inv F (int ^x18 ^x19) ^x0))) supposing { ~(equal (inv F (int ^x18 
^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     disj-simp 
from { 76 }
81.  (~(subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) v ~(subset (inv F (int ^x18 ^x19) ^x0) (int (inv F 
^x18 ^x0) (inv F ^x19 ^x0)))) supposing { ~(equal (inv F (int ^x18 
^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     disj-cond-2 
from { 77 }
84.  ((subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) -> ~(subset (inv F (int ^x18 ^x19) ^x0) (int (inv F 
^x18 ^x0) (inv F ^x19 ^x0)))) supposing { ~(equal (inv F (int ^x18 
^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     disj-simp 
from { 81 }
79.  (mem x86 x85) supposing { (mem x86 x85) }     reductio-supposition
80.  (subset x90 x89) supposing { (subset x90 x89) }     reductio-supposition
89.  ((subset x6 x4) -> (equal x4 x6)) supposing { (subset x4 x6) } 
modus-ponens2 from { 20 , 80 }
94.  (equal x4 x6) supposing { (subset x4 x6) , (subset x6 x4) } 
modus-ponens1 from { 89 , 80 }
532.  ~(subset ^x18 ^@y39) supposing { (subset ^@y39 ^x18) , ~(equal 
^@y39 ^x18) }     reductio from { 94 , 531 }
535.  ((subset ^x18 ^@y39) -> ~(subset ^@y39 ^x18)) supposing { 
~(equal ^@y39 ^x18) }     contra-conditionalization from { 532 }
540.  (~(subset ^x18 ^@y38) v ~(subset ^@y38 ^x18)) supposing { 
~(equal ^@y39 ^x18) }     disj-cond from { 535 }
541.  ~((subset ^x18 ^@y38) & (subset ^@y38 ^x18)) supposing { 
~(equal ^@y39 ^x18) }     i-DM from { 540 }
641.  ~(equal ^x18 x6) supposing { ~(equal ^@y39 ^x18) } 
modus-tollens2 from { 18 , 541 }
668.  ~(subset ^x18 ^@y106) supposing { ~(equal ^@y39 ^x18) , (subset 
^@y106 ^x18) }     reductio from { 641 , 94 }
671.  ((subset ^@y38 ^x18) -> ~(subset ^x18 ^@y38)) supposing { 
~(equal ^@y39 ^x18) }     conditionalization from { 668 }
740.  ~(subset ^x18 ^x18) supposing { ~(equal ^@y39 ^x18) } 
cond-simp1 from { 671 }
741.  (mem (@y9 ^x18 ^x18) ^x18) supposing { ~(equal ^@y39 ^x18) } 
modus-tollens2 from { 46 , 740 }
1396.  (subset ^x18 ^x18) supposing { ~(equal ^@y39 ^x18) } 
modus-ponens2 from { 47 , 741 }
751.  ~(mem (@y9 ^x18 ^x18) ^x18) supposing { ~(equal ^@y39 ^x18) } 
modus-tollens2 from { 47 , 740 }
752.  ~((mem (@y9 ^x18 ^x18) ^x18) -> (mem (@y9 ^x18 ^x18) ^x18)) 
supposing { ~(equal ^@y39 ^x18) }     i-neg-condit from { 751 , 741 }
753.  (some x)~((mem x ^x18) -> (mem x ^x18)) supposing { ~(equal 
^@y39 ^x18) }     EG from { 752 }
754.  ~(all x)((mem x ^x18) -> (mem x ^x18)) supposing { ~(equal 
^@y39 ^x18) }     i-neg-ug from { 753 }
1404.  ~((subset ^x18 ^x18) -> (all x)((mem x ^x18) -> (mem x ^x18))) 
supposing { ~(equal ^@y39 ^x18) }     i-neg-condit from { 754 , 1396 }
1405.  (equal ^@y39 ^x18)     reductio from { 1404 , 14 }
1423.  ((subset x4 ^x18) & (subset ^x18 x4))     modus-ponens2 from { 
18 , 1405 }
...
86.  ~(subset (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv 
F ^x19 ^x0))) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int 
(inv F ^x18 ^x0) (inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0)) (inv F (int ^x18 ^x19) ^x0)) }     modus-ponens2 
from { 84 , 80 }
115.  (mem (@y9 (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) (inv F (int ^x18 ^x19) ^x0)) supposing { ~(equal 
(inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) 
, (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 
^x19) ^x0)) }     modus-tollens2 from { 46 , 86 }
117.  ~(mem (@y9 (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) supposing 
{ ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F 
(int ^x18 ^x19) ^x0)) }     modus-tollens2 from { 47 , 86 }
90.  (all x)((mem x x2) -> (mem x x5)) supposing { (subset x2 x5) } 
modus-ponens2 from { 14 , 80 }
93.  ((mem x95 x2) -> (mem x95 x5)) supposing { (subset x2 x5) } 
UI from { 90 }
128.  (mem (@y9 (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) x5) supposing { (subset (inv F (int ^x18 ^x19) 
^x0) x5) , ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) 
(inv F (int ^x18 ^x19) ^x0)) }     modus-ponens2 from { 93 , 115 }
129.  ~((mem (@y9 (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) ^@y42) -> (mem (@y9 (inv F (int ^x18 ^x19) ^x0) 
(int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0)))) supposing { (subset (inv F (int ^x18 ^x19) ^x0) ^@y42) , 
...
130.  (some x)~((mem x ^@y42) -> (mem x (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0)))) supposing { (subset (inv F (int ^x18 ^x19) ^x0) ^@y42) , 
~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 
^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) }     EG from { 129 }
131.  ~(all x)((mem x ^@y42) -> (mem x (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0)))) supposing { (subset (inv F (int ^x18 ^x19) ^x0) ^@y42) , 
~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 
^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) }     i-neg-ug from { 130 }
137.  ~(subset x2 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) supposing 
{ (subset (inv F (int ^x18 ^x19) ^x0) x2) , ~(equal (inv F (int ^x18 
^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) , (subset (int 
(inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 ^x19) ^x0)) } 
modus-tollens2 from { 14 , 131 }
1491.  ~(subset (inv F (int ^x18 ^x19) ^x0) ^x18) supposing { ~(equal 
(inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) 
, (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 
^x19) ^x0)) }     reductio from { 1460 , 137 }
1753.  (mem (@y9 (inv F (int ^x18 ^x19) ^x0) ^x18) (inv F (int ^x18 
^x19) ^x0)) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv 
F ^x18 ^x0) (inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0)) (inv F (int ^x18 ^x19) ^x0)) }     modus-tollens2 from { 
46 , 1491 }
166.  ~(subset (inv F (int ^x18 ^x19) ^x0) ^@y41) supposing { (subset 
(int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 ^x19) ^x0)) 
, ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0))) , (subset ^@y41 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) 
}     reductio from { 137 , 80 }
229.  ~(mem (@y9 (inv F (int ^x18 ^x19) ^x0) x5) x5) supposing { 
(subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 
^x19) ^x0)) , ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 
^x0) (inv F ^x19 ^x0))) , (subset x5 (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0))) }     modus-tollens2 from { 47 , 166 }
311.  ~(subset ^@y43 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) 
supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) 
(inv F (int ^x18 ^x19) ^x0)) , (mem (@y9 (inv F (int ^x18 ^x19) ^x0) 
^@y43) ^@y43) }     reductio from { 229 , 79 }
1479.  ~(mem (@y9 (inv F (int ^x18 ^x19) ^x0) ^x18) ^x18) supposing { 
~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 
^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) }     reductio from { 1460 , 311 }
1806.  ~(mem (@y9 (inv F (int ^x18 ^x19) ^x0) ^x18) x2) supposing { 
~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 
^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) }     modus-tollens2 from { 1528 , 1479 }
1813.  ~((mem (@y9 (inv F (int ^x18 ^x19) ^x0) ^x18) (inv F (int ^x18 
^x19) ^x0)) -> (mem (@y9 (inv F (int ^x18 ^x19) ^x0) ^x18) ^@y43)) 
supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) 
(inv F (int ^x18 ^x19) ^x0)) }     i-neg-condit from { 1806 , 1753 }
1814.  (some x)~((mem x (inv F (int ^x18 ^x19) ^x0)) -> (mem x 
^@y43)) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F 
^x18 ^x0) (inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F 
^x19 ^x0)) (inv F (int ^x18 ^x19) ^x0)) }     EG from { 1813 }
1815.  ~(all x)((mem x (inv F (int ^x18 ^x19) ^x0)) -> (mem x ^@y43)) 
supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))) , (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) 
(inv F (int ^x18 ^x19) ^x0)) }     i-neg-ug from { 1814 }
1924.  ~(subset (inv F (int ^x18 ^x19) ^x0) x5) supposing { ~(equal 
(inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) 
, (subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 
^x19) ^x0)) }     modus-tollens2 from { 14 , 1815 }
1963.  ~(subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int 
(inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     reductio from { 1924 , 1424 
}
1975.  ~(mem (@y9 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) (inv F (int ^x18 ^x19) ^x0)) supposing { ~(equal 
(inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) 
}     modus-tollens2 from { 47 , 1963 }
1995.  ~(mem (@y9 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) ^x18) supposing { ~(equal (inv F (int ^x18 ^x19) 
^x0) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     modus-tollens2 
from { 1527 , 1975 }
1968.  (mem (@y9 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int 
^x18 ^x19) ^x0)) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) supposing { 
~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv F ^x19 
^x0))) }     modus-tollens2 from { 46 , 1963 }
2000.  ~((mem (@y9 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F 
(int ^x18 ^x19) ^x0)) (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) -> 
(mem (@y9 (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) (inv F (int ^x18 
^x19) ^x0)) ^x18)) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) 
(int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     i-neg-condit from { 
1995 , 1968 }
2001.  (some x)~((mem x (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) -> 
(mem x ^x18)) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int 
(inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     EG from { 2000 }
2002.  ~(all x)((mem x (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) -> 
(mem x ^x18)) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int 
(inv F ^x18 ^x0) (inv F ^x19 ^x0))) }     i-neg-ug from { 2001 }
2003.  ~((subset (int (inv F ^x18 ^x0) (inv F ^x19 ^x0)) ^x18) -> 
(all x)((mem x (int (inv F ^x18 ^x0) (inv F ^x19 ^x0))) -> (mem x 
^x18))) supposing { ~(equal (inv F (int ^x18 ^x19) ^x0) (int (inv F 
^x18 ^x0) (inv F ^x19 ^x0))) }     i-neg-condit from { 2002 , 1424 }
2004.  (equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) (inv 
F ^x19 ^x0)))     reductio from { 2003 , 14 }
2006.  (((maps F ^x0 ^x17) & ((subset ^x18 ^x17) & (subset ^x19 
^x17))) -> (equal (inv F (int ^x18 ^x19) ^x0) (int (inv F ^x18 ^x0) 
(inv F ^x19 ^x0))))     conditionalization from { 2004 }
2007.  (all Y)(((maps F ^x0 ^x17) & ((subset ^x18 ^x17) & (subset Y 
^x17))) -> (equal (inv F (int ^x18 Y) ^x0) (int (inv F ^x18 ^x0) (inv 
F Y ^x0))))     UG from { 2006 }
2008.  (all X)(all Y)(((maps F ^x0 ^x17) & ((subset X ^x17) & (subset 
Y ^x17))) -> (equal (inv F (int X Y) ^x0) (int (inv F X ^x0) (inv F Y 
^x0))))     UG from { 2007 }
2009.  (all B)(all X)(all Y)(((maps F ^x0 B) & ((subset X B) & 
(subset Y B))) -> (equal (inv F (int X Y) ^x0) (int (inv F X ^x0) 
(inv F Y ^x0))))     UG from { 2008 }
2010.  (all A)(all B)(all X)(all Y)(((maps F A B) & ((subset X B) & 
(subset Y B))) -> (equal (inv F (int X Y) A) (int (inv F X A) (inv F 
Y A))))     UG from { 2009 }
