...
;(setf oscar-pathname
;         (parse-namestring
;           "G4 HOME:DOCUMENTS:STABLE:OSCAR:OSCAR FOLDER:"))
...
(defunction build-hyper-defeat-link (root target)
...
(defunction hyper-defeat-link (n)
...
(defun print-hypernode (x stream depth)
    ...
    (princ (hypernode-number x) stream) (princ ">" stream))
...
(defunction current-maximal-degree-of-justification (node)
    (cond
      (*deductive-only* 1.0)
      ((temporal-node node)
...
(defunction current-degree-of-justification (node)
    (cond
      (*deductive-only* 1.0)
      ((temporal-node node)
...
(defunction compute-old-degree-of-justification (node)
    (if (and (temporal-node node) (old-degree-of-justification node))
      (adjust-for-time (old-degree-of-justification node) node)
      (old-degree-of-justification node)))
...
(defunction hypernode-consequences (n)
    (mapcar #'hyperlink-target (consequent-links n)))

(defunction hypernode (n)
    (find-if #'(lambda (node) (equal (hypernode-number node) n))
                 *hypergraph*))

(defunction display-hypernode (n )
...
(defunction display-hyperlink (L)
    ...
    (let ((n (hyperlink-target L)))
      ...
      (let ((links (remove L (hyperlinks n))))
        (when links
...
(defunction display-unsupported-hypernode (n )
    (if (numberp n) (setf n (hypernode n)))
...
(defunction hypernode-defeatees (node)
    (mapcar #'hyper-defeat-link-target (supported-hyper-defeat-links node)))

(defunction hyperlink-hypernode-defeaters (link)
...
(defunction inclusive-hypernode-ancestors (node)
    (cons node (hypernode-ancestors node)))

(defunction ancestral-links (node)
    (unionmapcar+ #'hyperlinks (inclusive-hypernode-ancestors node)))
...
(defunction store-hypernode (node formula)
...
#| (descrimination-tests d-node) is an a-list of pairs (test . dn), where test has the form of the
car of a formula-code, and dn is a d-node. |#
(defunction index-hypernode (node profile term-list d-node)
    (let ((dn (e-assoc (car profile) (discrimination-tests d-node)))
            (new-profile (cdr profile)))
       (cond (dn
...
(defunction store-hypernode-at-d-node (node term-list dn)
...
#| Test is the final member of the formula-profile for the hypernode-formula. |#
(defunction store-hypernode-at-new-d-node (node term-list d-node test)
...
(defunction index-hypernode-at-new-nodes (node term-list d-node profile test)
    (let ((dn (make-d-node
                     :d-node-number (incf *d-node-number*)
                     :d-node-description (cons test (d-node-description d-node))
                     :parent-d-node d-node)))
...
(defunction store-hypernode-with-c-list (node formula c-list)
...
(defunction store-processed-node (node)
...
(defunction premise-hypernode-specifier (premise)
...
(defunction convert-reductio-supposition (sup discount-factor)
    (setf (reductio-ancestors sup) (list (cons (hypernode-formula sup) sup)))
...
(defunction graph-log-on () (setf *graph-log* t))
(defunction graph-log-off () (setf *graph-log* nil))
...
in the Listener. |#
(defunction graphics-pause-on () (setf *graphics-pause* t))
(defunction graphics-pause-off () (setf *graphics-pause* nil))
    ...
    (let* ((formula (mem1 premise))
              ...
              (node
                (make-hypernode
                  ...
                  :old-degree-of-justification (mem2 premise)
       ...
       (setf (hypernode-queue-node node) queue-node)
       (setf (hyperlinks node) (list link))
...
(defunction test* (&optional n)
    (cond ((null n)
                (dolist (P *problems*)
                    (run-reasoning-problem* P)))
              (t (run-reasoning-problem* (assoc n *problems*)))))

(defunction test&load ()
    ...
    (let ((DI (enabling-interests n)))
       (cond
         ...
         (DI
           ...
           (let ((SL (find-if #'(lambda (SL) (equal (hyperlink-rule SL) :reductio)) (hyperlinks n))))
              (when SL
...
(defunction reason-degenerately-backwards-from-dominant-reason-nodes
...
(defunction construct-interest-link
    ...
    (when *trace* (indent depth) (princ "CONSTRUCT-INTEREST-LINK for interest ")
                ...
                (princ " and nodes ") (princ (mapcar #'hypernode-number (supporting-nodes link0)))
                (terpri))
    (cond
      ((and (backwards-premise-p (car remaining-premises))
                (listp (bp-formula (car remaining-premises)))
               ...
               (let ((link
                         (make-interest-link
                           ...
                           (cond ((eq (link-rule link0) :answer)
                                       (maximum-degree-of-interest (resultant-interest link0)))
                 ...
                 (push link *interest-links*)
                 (push link (left-links (resultant-interest link0)))
                 (compute-link-interest
                   link (bp-condition1 premise) (bp-condition2 premise)
   ...
   ; (when (eq link (link 1)) (break))
    (let* ((C (mem1 (supporting-nodes link)))
       ...
       (cond ((and (not (zerop degree))
                           ...
                           (or (null (old-degree-of-justification C))
                                 (zerop (old-degree-of-justification C))
                                 (< (old-degree-of-justification C) (query-strength Q))))
...
(defunction delete-arguments (link node L0 depth)
    ...
    (when (and (not (member link *deleted-arguments*))
         ...
         (pull link (hyperlinks node))
         (cond ((null (hyperlinks node)) (cancel-node node (if *trace* depth 0)))
                     (t
                       (dolist (L (hyperlinks node))
                           (let ((NDA
...
(defunction link-ancestor (L link)
    (some #'(lambda (N) (member L (hyperlinks N)))
...
(defunction reductio-supposition (node) (eq (hypernode-justification node) :reductio-supposition))
...
(defunction build-hyperlink (basis clues rule discount node NDA binding link instantiations depth defeasible?)
    ...
    (when (not (some #'(lambda (L)
         ...
         (let* ((new? (null (hyperlinks node)))
           ...
           (when (or (not (member nil NDA))
                ...
                (if (null (temporal-node node)) (setf (temporal-node node) (temporal-hyperlink link)))
...
(defunction recursively-compute-hypernode-ancestors (node ancestors)
    (dolist (L (consequent-links node))
...
(defunction add-hyperlink (link node depth)
    ...
    (let ((degree-of-justification
      ...
      (cond ((and (temporal-hyperlink link) (not (eql (temporal-node node) *cycle*)))
                                    ...
                                    (dolist (L (hyperlinks node))
                                        ...
                                        (when (and (not (keywordp (hyperlink-rule L))) (temporal? (hyperlink-rule L)))
                                             (setf (hyperlink-reason-strength L)
                                                      (adjust-for-decay (hyperlink-reason-strength L) decay)))
                                        (setf (temporal-hyperlink L) *cycle*))
           ...
           (cond ((null undercutting-interest)
                       (setf undercutting-interest
                                (make-interest
                                  ...
                                  :interest-priority *base-priority*
                                  :defeater-binding (hyperlink-binding link)
                ...
                (dolist (corresponding-i-list corresponding-i-lists)
                    (let* ((i-list (mem1 corresponding-i-list))
                              (interest-candidates
                                (subset
                                  #'(lambda (N)
                                        (not (member node (discharging-nodes N))))
                        ...
                        (dolist (L (interest-defeatees N))
                            ...
                            (when (deductive-node node)
                                 (let ((node* (hyperlink-target L)))
                                   ...
                                   (cond ((every #'hyperlink-conclusive-defeat-status (hyperlinks node*))
...
(defunction compute-hypernode-dependencies (node indent msg)
    (when *d-trace*
...
(defunction anchor-hypernode-relative-to-interest (node I indent msg)
...
(defunction anchor-hypernode-relative-to-node (node N0 indent msg)
    (pull node *dependent-nodes*)
    (when *d-trace*
         (bar-indent indent) (princ msg) (princ node) (terpri))
    (dolist (n (hypernode-consequences node))
...
(defunction compute-undefeated-degrees-of-support () ; (break)
    ...
    (let* ((immediately-altered-nodes
      ...
      (dolist (N altered-nodes)
          (setf (old-degree-of-justification N) (degree-of-justification N)))
      (let ((undefeated-links
        ...
        (dolist (node altered-nodes)
            (let ((old-degree-of-justification (compute-old-degree-of-justification node)))
              (cond
                ((null (old-degree-of-justification node))
                ...
                ((> (degree-of-justification node) old-degree-of-justification)
                  (push node new-beliefs))
                ((< (degree-of-justification node) old-degree-of-justification)
                  (push node new-retractions)))))
...
(defunction hypernode-descendants-of-interest (interest)
...
(defunction discharge-ultimate-epistemic-interests (new-beliefs new-retractions)
   ...
   (let ((altered-queries nil))
     (dolist (C new-beliefs)
      ...
      (dolist (C new-retractions)
          (dolist (Q (answered-queries C))
              (when (and (old-degree-of-justification C)
                                  (>= (old-degree-of-justification C) (query-strength Q))
...
(defunction formula-hypernode-variables (p)
...
(defunction hypernode-unifier (n m)
...
(when (and (equal (lisp-implementation-type) "Macintosh Common Lisp")
                    (null *menus-loaded*))
     (load (concatenate 'string oscar-pathname "menu"))
     (setf *menus-loaded* t))

(when (null *prob-compiler-loaded*)
     (load (concatenate 'string oscar-pathname "reason"))
     (load (concatenate 'string oscar-pathname "problem-compiler"))
...
(when (null *problems-loaded*)
     ...
     (load (concatenate 'string oscar-pathname "problem.lisp"))
     (load (concatenate 'string oscar-pathname "argument"))
     (setf *problems-loaded* t))

(setf *comparison-log*
 '(OSCAR_3.31 0.23 0.23 10 0.95
 ((104 206 37 78) (103 797 43 252) (102 107 30 44) (100 16 9 10) (99 351 33 164) (98 254 41 120) (97 82 33 43) (96 29 12 18) (95 82 40 46)
  (94 178 35 66) (93 38 18 24) (92 33 14 14) (91 16 8 8) (90 415 43 101) (89 97 25 48) (88 38 13 20) (87 29 12 14) (86 1237 111 297) (85 94 31 45)
  (84 32 19 20) (83 27 16 18) (82 23 13 17) (81 93 39 47) (80 38 22 23) (79 41 26 27) (78 77 38 44) (77 18 12 13) (76 74 32 40) (75 51 19 27)
  (74 22 14 15) (73 45 17 27) (72 32 13 16) (71 60 13 24) (70 27 8 12) (69 10 5 5) (68 8 4 4) (67 7 4 4) (66 6 4 4) (65 28 16 18) (64 32 18 20)
  (63 26 15 17) (62 13 8 8) (61 38 17 21) (60 61 23 32) (59 13 6 6) (58 16 8 8) (57 13 7 7) (56 18 8 10) (55 5 4 4) (54 28 15 18) (53 42 21 23)
  (52 17 11 11) (51 15 9 9) (50 12 8 8) (49 10 5 6) (48 8 4 5) (47 8 6 6) (46 18 12 12) (45 9 5 5) (44 11 6 8) (43 5 3 3) (42 8 5 5) (41 4 3 3)
  (37 87 36 51) (36 8 5 7) (35 7 4 5) (34 37 18 24) (33 60 27 36) (32 183 80 95) (31 4 3 3) (30 23 18 18) (29 18 12 12) (28 8 4 5) (27 5 3 3)
  (26 4 3 3) (25 17 11 12) (24 21 11 15) (23 7 4 6) (22 4 3 3) (21 18 11 14) (18 19 7 8) (17 87 21 27) (16 105 21 29) (15 29 12 13) (14 32 13 14)
  (13 31 12 13) (12 20 10 11) (11 18 8 9) (10 12 4 5) (9 61 13 16) (8 57 9 12) (7 45 9 14) (6 41 16 19) (5 38 11 14) (4 22 8 10) (3 27 14 17)
  (2 22 7 10) (1 21 7 8)))
)
...
#|
(setf *comparison-log*
 '(OSCAR_3.20 0.25 0.25 10 0.95
 ((104 163 37 78) (103 600 55 256) (102 74 24 42) (100 13 9 10) (99 1285 145 464) (98 219 41 120) (97 64 33 42) (96 24 12 19) (95 69 40 46)
  (94 68 27 35) (93 25 18 19) (92 30 14 14) (91 14 8 8) (90 288 43 94) (89 56 26 33) (88 26 13 20) (87 24 12 14) (86 1399 100 367) (85 78 31 45)
  (84 27 19 20) (83 20 16 17) (82 20 13 17) (81 79 39 47) (80 33 22 23) (79 38 26 27) (78 66 38 44) (77 15 12 13) (76 53 32 35) (75 37 19 27)
  (74 21 14 15) (73 40 17 27) (72 25 13 16) (71 47 13 24) (70 22 8 12) (69 9 5 5) (68 7 4 4) (67 8 4 4) (66 5 4 4) (65 25 16 18) (64 27 18 20)
  (63 23 15 17) (62 12 8 8) (61 33 17 21) (60 52 23 32) (59 11 6 6) (58 13 8 8) (57 12 7 7) (56 15 8 10) (55 6 4 4) (54 23 15 18) (53 31 21 24)
  (52 16 11 11) (51 12 9 9) (50 9 8 8) (49 9 5 6) (48 8 4 5) (47 7 6 6) (46 16 12 12) (45 8 5 5) (44 9 6 8) (43 4 3 3) (42 7 5 5) (41 4 3 3)
  (37 79 36 51) (36 9 5 7) (35 6 4 5) (34 34 18 24) (33 47 27 36) (32 164 80 95) (31 3 3 3) (30 22 18 18) (29 17 12 12) (28 7 4 5) (27 5 3 3)
  (26 5 3 3) (25 16 11 12) (24 20 11 15) (23 6 4 6) (22 5 3 3) (21 18 11 14) (18 51 7 8) (17 192 21 27) (16 200 21 29) (15 26 12 13) (14 48 13 14)
  (13 45 12 13) (12 19 10 11) (11 17 8 9) (10 11 4 5) (9 193 13 16) (8 184 9 12) (7 84 9 14) (6 57 16 19) (5 71 11 14) (4 38 8 10) (3 26 14 17)
  (2 38 7 10) (1 38 7 8)))
)
|#
