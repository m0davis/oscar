...
%if False
\begin{code}
-- Named is used simply to avoid the error: "Instance search can only be used to find elements in a named type"
-- See https://lists.chalmers.se/pipermail/agda-dev/2015-January/000048.html
