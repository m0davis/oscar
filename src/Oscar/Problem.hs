...
module Oscar.Problem (
    ...
    Direction(Forwards),
    Direction(Backwards),
    Defeasibility(PrimaFacie),
    Defeasibility(Conclusive),
    ProblemJustificationDegree(ProblemJustificationDegree),
    ProblemInterestDegree(ProblemInterestDegree),
    ProblemStrengthDegree(ProblemStrengthDegree),
    ...
    _rbProblemVariablesText,
    _rbProblemStrengthDegree,
    ForwardsReason(ForwardsReason),
    _frForwardsPremises,
    _frConclusion,
    BackwardsReason(BackwardsReason),
    _brForwardsPremises,
    _brBackwardsPremises,
    _brConclusion,
    Problem(Problem),
    _problemNumber,
    _problemDescription,
    _premises,
    _interests,
    _forwardsPrimaFacieReasons,
    _forwardsConclusiveReasons,
    _backwardsPrimaFacieReasons,
    _backwardsConclusiveReasons,
    -- * all the rest
    problemSectionText,
