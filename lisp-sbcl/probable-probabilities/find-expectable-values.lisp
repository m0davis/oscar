...
(when (not (boundp '*loaded*))
     (progn
         ...
         (load "PB12:documents:writings:papers:probability:the y-function:sampling:LISP Ä:analyze-probability-structure.lisp")
         (setf *loaded* t)
         ))
...
(defun  find-expectable-value (v tc args dif display)
    ;(setf v* v tc* tc args* args dif* dif display* display)
    ;; (step (find-expectable-value v* tc* args* dif* t))
