...
open import Oscar.Data.Term.Core FunctionName public
open import Oscar.Data.Term.Injectivity FunctionName public
open import Oscar.Data.Term.Substitution FunctionName public
open import Oscar.Data.Term.instances.Substitution public
open import Oscar.Data.Term.instances.TermSubstitution FunctionName public
...
-- -- -- subfact3 : ∀ {l m n} (f : m ⊸ n) (r : Fin l → Fin m) → (f ◇ (▹ r)) ≡ (f ∘ r)
-- -- -- subfact3 f r = refl
...
-- -- -- ThickAndThin.thin ThickAndThinTerm = mapTerm ∘ thin
