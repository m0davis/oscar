...
--  EquivalenceExtension : ∀ {a} {A : Ø a} {b} {B : A → Ø b} {x y} → Equivalence (Extension B x y) b
--  Equivalence._≋_ EquivalenceExtension = Proposextensequality

  Equivalence₂Extension : ∀ {a} {A : Ø a} {b} {B : A → Ø b} → Equivalence₂ (Extension B) b
  Equivalence₂._≈_ Equivalence₂Extension = Proposextensequality
...
module PropertyExtension where
  ...
  module _
    ...
    instance
      ...
      Extensionality₂Extension : Extensionality₂ (Extension B) b -- ⦃ EquivalenceExtension {B = _} ⦄
      ...
      IsCategoryExtension : IsCategory (Extension B) b
...
module SubstitunctionExtensionTermProperty {𝔭} (𝔓 : Ø 𝔭) where
  ...
  instance
    ...
    Equivalence₂Substitunction : Equivalence₂ Substitunction ∅̂
    Equivalence₂._≈_ Equivalence₂Substitunction = Proposextensequality

  private

    mutual

      𝓮xtensionality₁SubstitunctionExtensionTerm : 𝓮xtensionality₁ Substitunction ∅̂ (Extension Term) 𝔭 ¡
      ...
      𝓮xtensionality₁SubstitunctionExtensionTerms : ∀ {N} → 𝓮xtensionality₁ Substitunction ∅̂ (Extension $ Terms N) 𝔭 ¡
  ...
  instance
    ...
    Extensionality₁Substitunction : Extensionality₁ Substitunction ∅̂ (Extension Term) 𝔭 ¡
  ...
  private
    ...
    mutual
      ...
      𝓬ommutativitySubstitunctionExtensionTerm : 𝓬ommutativity Substitunction (Extension Term) 𝔭 ¡
  ...
  instance
    ...
    CommtativitySubstitunctionExtensionTerm : Commutativity Substitunction (Extension Term) 𝔭 ¡
    Commutativity.commutativity CommtativitySubstitunctionExtensionTerm = 𝓬ommutativitySubstitunctionExtensionTerm
    --CommtativitySubstitunctionExtensionTerm = record { commutativity = 𝓬ommutativitySubstitunctionExtensionTerm }

    CommtativitySubstitunctionExtensionTerms : ∀ {N} → Commutativity Substitunction (Extension $ Terms N) 𝔭 ¡
    Commutativity.commutativity CommtativitySubstitunctionExtensionTerms = 𝓬ommutativitySubstitunctionExtensionTerms
    --CommtativitySubstitunctionExtensionTerms = record { commutativity = 𝓬ommutativitySubstitunctionExtensionTerms }

    AssociativitySubstitunction : Associativity Substitunction ∅̂
    Associativity.associativity AssociativitySubstitunction f g h x = {!commutativity g h!}
    -- g h $ (f x)

    -- AssociativitySubstitunction = record { associativity = λ f g h x → commutativity g h $ (f x) }
