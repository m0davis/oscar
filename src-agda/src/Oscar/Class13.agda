...
module _ where
  ...
  module _
    ...
    module _
      ...
      record 𝓣ransextensionality/ : Ø a ∙̂ m ∙̂ ℓ where field transextensionality : 𝓽ransextensionality/
    record 𝓣ransextensionality∁ : Ø a ∙̂ m ∙̂ ℓ where
      field
        ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ _⊸_
        ⦃ ⌶𝓣ransextensionality/ ⦄ : 𝓣ransextensionality/
      open 𝓣ransextensionality/ ⌶𝓣ransextensionality/ public
  ...
  module _
    ...
    module _
      ...
      record 𝓣ransassociativity/ : Ø a ∙̂ m ∙̂ ℓ where field transassociativity : 𝓽ransassociativity/
    record 𝓣ransassociativity∁ : Ø a ∙̂ m ∙̂ ℓ where
      field
        ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ _⊸_
        ⦃ ⌶𝓣ransassociativity/ ⦄ : 𝓣ransassociativity/
      open 𝓣ransassociativity/ ⌶𝓣ransassociativity/ public
    record 𝓣ransassociativity : Ø a ∙̂ m ∙̂ ℓ where
      field
        ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ _⊸_
        ⦃ ⌶𝓣ransassociativity/ ⦄ : 𝓣ransassociativity/
      instance ∁ : 𝓣ransassociativity∁
      ∁ = record {}
    record 𝓣ransassociativity : Ø a ∙̂ m ∙̂ ℓ where
      field
        ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ _⊸_
    ...
    foo : ⦃ ⌶𝓣ransitivity∁ : 𝓣ransitivity∁ _⊸_ ⦄ → Ø a ∙̂ m ∙̂ ℓ
    foo = 𝓣ransassociativity
  ...
  record Transassociativity o a ℓ : Ø ↑̂ (o ∙̂ a ∙̂ ℓ) where
    field
      Object : Ø o
      Arrow : Object → Object → Ø a
      ArrowRelation : ∀ {x y} → Arrow x y → Arrow x y → Ø ℓ
      ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ Arrow
      instance / : 𝓣ransassociativity/ Arrow ArrowRelation
    instance ∁ = 𝓣ransassociativity∁ Arrow ArrowRelation ∋ record {}
  ...
  module Test where
    postulate
      ...
      _⊸'_ : A → A → Set
      _≋_ : ∀ {x y} → x ⊸ y → x ⊸ y → Set
      _≋2_ : ∀ {x y} → x ⊸ y → x ⊸ y → Set
      _≋'_ : ∀ {x y} → x ⊸' y → x ⊸' y → Set
      instance _ : 𝓣ransitivity∁ _⊸_
      instance _ : 𝓣ransitivity∁ _⊸'_

    instance TransassociativityA : 𝓣ransassociativity _⊸_ _≋_
    TransassociativityA .𝓣ransassociativity.⌶𝓣ransitivity∁ = !
    TransassociativityA .𝓣ransassociativity.⌶𝓣ransassociativity/ .𝓣ransassociativity/.transassociativity = magic

    test : ∀ {w x y z} (f : w ⊸ x) (g : x ⊸ y) (h : y ⊸ z) → ((h ∙ g) ∙ f) ≋ (h ∙ g ∙ f)
...
module _ where
  ...
  module _
    ...
    module _
      ...
      where
      𝓶ap/ = ∀ {x y} → x ⊸₁ y → μ x ⊸₂ μ y
      record 𝓜ap/ : Ø a₁ ∙̂ m₁ ∙̂ a₂ ∙̂ m₂ where field map : 𝓶ap/
...
module _ where
  ...
  module _
    ...
    module _
      ...
      record 𝓜apextensionality/ : Ø a₁ ∙̂ m₁ ∙̂ a₂ ∙̂ m₂ ∙̂ ℓ₁ ∙̂ ℓ₂ where field mapextensionality : 𝓶apextensionality/
    record 𝓜apextensionality∁ : Ø a₁ ∙̂ m₁ ∙̂ a₂ ∙̂ m₂ ∙̂ ℓ₁ ∙̂ ℓ₂ where
      field
        ⦃ ⌶𝓜ap∁ ⦄ : 𝓜ap∁ _⊸₁_ _⊸₂_
        ⦃ ⌶𝓜apextensionality/ ⦄ : 𝓜apextensionality/
      open 𝓜apextensionality/ ⌶𝓜apextensionality/ public
...
module _ where
  ...
  module _
    ...
    module _
      ...
      record 𝓜aptranscommutativity/ : Ø a₁ ∙̂ a₂ ∙̂ m₁ ∙̂ m₂ ∙̂ ℓ₂ where field maptranscommutativity : 𝓶aptranscommutativity/
    record 𝓜aptranscommutativity∁ : Ø a₁ ∙̂ a₂ ∙̂ m₁ ∙̂ m₂ ∙̂ ℓ₂ where
      field
        ⦃ ⌶𝓜ap∁ ⦄ : 𝓜ap∁ _⊸₁_ _⊸₂_
        ⦃ ⌶𝓣ransitivity∁₁ ⦄ : 𝓣ransitivity∁ _⊸₁_
        ⦃ ⌶𝓣ransitivity∁₂ ⦄ : 𝓣ransitivity∁ _⊸₂_
        ⦃ ⌶𝓜aptranscommutativity/ ⦄ : 𝓜aptranscommutativity/
      open 𝓜aptranscommutativity/ ⌶𝓜aptranscommutativity/ public
...
module _ where
  ...
  module _
    ...
    module _
      ...
      record 𝓣ransleftidentity/ : Ø o ∙̂ a ∙̂ ℓ where field transleftidentity : 𝓽ransleftidentity/
    record 𝓣ransleftidentity∁ : Ø o ∙̂ a ∙̂ ℓ where
      field
        ⦃ ⌶𝓡eflexivity∁ ⦄ : 𝓡eflexivity∁ Arrow
        ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ Arrow
        ⦃ ⌶𝓣ransleftidentity/ ⦄ : 𝓣ransleftidentity/
      open 𝓣ransleftidentity/ ⌶𝓣ransleftidentity/ public
  ...
  module _
    ...
    module _
      ...
      record 𝓣ransrightidentity/ : Ø o ∙̂ a ∙̂ ℓ where field transrightidentity : 𝓽ransrightidentity/
    record 𝓣ransrightidentity∁ : Ø o ∙̂ a ∙̂ ℓ where
      field
        ⦃ ⌶𝓡eflexivity∁ ⦄ : 𝓡eflexivity∁ Arrow
        ⦃ ⌶𝓣ransitivity∁ ⦄ : 𝓣ransitivity∁ Arrow
        ⦃ ⌶𝓣ransrightidentity/ ⦄ : 𝓣ransrightidentity/
      open 𝓣ransrightidentity/ ⌶𝓣ransrightidentity/ public
...
module _ where
  ...
  module _
    ...
    module _
      ...
      record 𝓜apidentity/ : Ø o₁ ∙̂ a₁ ∙̂ o₂ ∙̂ a₂ ∙̂ ℓ₂ where field mapidentity : 𝓶apidentity/
    record 𝓜apidentity∁ : Ø o₁ ∙̂ a₁ ∙̂ o₂ ∙̂ a₂ ∙̂ ℓ₂ where
      field
        ⦃ ⌶𝓜ap∁ ⦄ : 𝓜ap∁ Arrow₁ Arrow₂
        ⦃ ⌶𝓡eflexivity∁₁ ⦄ : 𝓡eflexivity∁ Arrow₁
        ⦃ ⌶𝓡eflexivity∁₂ ⦄ : 𝓡eflexivity∁ Arrow₂
        ⦃ ⌶𝓜apidentity/ ⦄ : 𝓜apidentity/
      open 𝓜apidentity/ ⌶𝓜apidentity/ public
...
module _ where
  ...
  record IsPrefunctor∁
    ...
    field
      ...
      ⦃ ⌶𝓜aptranscommutativity/ ⦄ : 𝓜aptranscommutativity/ Arrow₁ Arrow₂ ArrowEquivalent₂
  ...
  record IsFunctor∁
    ...
    field
      ...
      ⦃ ⌶IsCategory/₂ ⦄ : IsCategory/ Arrow₂ ArrowEquivalent₂
      ⦃ ⌶𝓜apidentity/ ⦄ : 𝓜apidentity/ Arrow₁ Arrow₂ ArrowEquivalent₂
