...
module Oscar.Property8 where

open import Oscar.Prelude
open import Oscar.Class8
...
module Proposequality⌶ where
  ...
  module _ {𝔬} {𝔒 : Ø 𝔬} where
    ...
    instance
      ...
      Identity′.identity ReflexivityProposequality = ∅

      SymmetryProposequality : Symmetry Proposequality⟦ 𝔒 ⟧
      Relationality.relationality SymmetryProposequality ∅ = ∅
...
module Proposextensequality⌶ where
  ...
  module _ {𝔬} {𝔒 : Ø 𝔬} {𝔭} {𝔓 : 𝔒 → Ø 𝔭} where
    ...
    instance
      ...
      Identity′.identity ReflexivityProposextensequality _ = ∅

      SymmetryProposextensequality : Symmetry Proposextensequality⟦ 𝔓 ⟧
      Relationality.relationality SymmetryProposextensequality f₁≡̇f₂ x rewrite f₁≡̇f₂ x = ∅
...
module Function⌶ where
  ...
  module _
    ...
    instance
      ...
      Identity′.identity ReflexivityFunction = ¡
...
module Extension⌶ where
  ...
  module _
    ...
    instance
      ...
      Identity′.identity ReflexivityExtension = ¡
...
record Substitunction⌶ {𝔭} (𝔓 : Ø 𝔭) : Ø₀ where
  ...
  instance
    ...
    Relationality.relationality Substitunction,ExtensionTerm⌶Map = 𝓶apSubstitunctionExtensionTerm

    Substitunction,ExtensionTerms⌶Map : ∀ {N} → Map Substitunction (Extension $ Terms N)
    Relationality.relationality Substitunction,ExtensionTerms⌶Map = 𝓶apSubstitunctionExtensionTerms
  ...
  instance
    ...
    Commutativity'SubstitunctionExtensionTerm : Commutativity' Substitunction ∅̂ 𝔭 𝔭
    Commutativity'.A₂ Commutativity'SubstitunctionExtensionTerm = _
    Commutativity'.B₂ Commutativity'SubstitunctionExtensionTerm = Extension Term
    Commutativity'.me Commutativity'SubstitunctionExtensionTerm = it
    Commutativity'.μ Commutativity'SubstitunctionExtensionTerm = ¡
    Commutativity'.t1 Commutativity'SubstitunctionExtensionTerm = it
    Commutativity'.t2 Commutativity'SubstitunctionExtensionTerm = it
    Commutativity'.mp Commutativity'SubstitunctionExtensionTerm = it
    Commutativity'.commutativity' Commutativity'SubstitunctionExtensionTerm = 𝓬ommutativitySubstitunctionExtensionTerm
  ...
  instance
    ...
    Commutativity'SubstitunctionExtensionTermμ : Commutativity' Substitunction ∅̂ 𝔭 𝔭
    Commutativity'.A₂ Commutativity'SubstitunctionExtensionTermμ = _
    Commutativity'.B₂ Commutativity'SubstitunctionExtensionTermμ = Extension Term
    Commutativity'.me Commutativity'SubstitunctionExtensionTermμ = it
    Commutativity'.μ Commutativity'SubstitunctionExtensionTermμ x = ↑ x
    Commutativity'.t1 Commutativity'SubstitunctionExtensionTermμ = {!!}
    Commutativity'.t2 Commutativity'SubstitunctionExtensionTermμ = {!!}
    Commutativity'.mp Commutativity'SubstitunctionExtensionTermμ = {!!}
    Commutativity'.commutativity' Commutativity'SubstitunctionExtensionTermμ = {!!}

    Commutativity'SubstitunctionExtensionTerms : ∀ {N : ¶} → Commutativity' Substitunction _ _ _
    Commutativity'.A₂ (Commutativity'SubstitunctionExtensionTerms {N}) = _
    Commutativity'.B₂ (Commutativity'SubstitunctionExtensionTerms {N}) = (Extension $ Terms N)
    Commutativity'.me (Commutativity'SubstitunctionExtensionTerms {N}) = it
    Commutativity'.μ (Commutativity'SubstitunctionExtensionTerms {N}) = ¡
    Commutativity'.t1 (Commutativity'SubstitunctionExtensionTerms {N}) = it
    Commutativity'.t2 (Commutativity'SubstitunctionExtensionTerms {N}) = it
    Commutativity'.mp (Commutativity'SubstitunctionExtensionTerms {N}) = it
    Commutativity'.commutativity' (Commutativity'SubstitunctionExtensionTerms {N}) = 𝓬ommutativitySubstitunctionExtensionTerms
...
-- !!!!!
    ...
    Identity′.identity ReflexivitySubstitunction = i
...
-}
    ...
    LeftIdentity.left-identity LeftIdentitySubstitunction {y = y} f = identity[ _ / Extension Term / _ ] ∘ f
    -- identity ⦃ IdentitySubstitunctionExtensionTerm ⦄ {x = y}
    -- ⦃ ReflexivityExtension {B = Term} ⦄
...
module AList⌶ {a} {A : Nat → Set a} where
  ...
  instance
    ...
    Identity′.identity Reflexivity⌶AList = ∅
...
module Substitist⌶ {𝔭} {𝔓 : Ø 𝔭} where
  ...
  instance
    ...
    Relationality.relationality Map⌶Substitist,Substitunction ∅ = i
    Relationality.relationality Map⌶Substitist,Substitunction ((x , t) , σ) = relationality σ ∙ (t for x)
...
module Fin⌶ where
  ...
  instance
    ...
    Relationality.relationality Map⌶Maybe f ∅ = ∅
    Relationality.relationality Map⌶Maybe f (↑ x) = ↑ (f x)
...
-- -- -- -- -- --       Relationality.relationality Map⌶ExtensionFin,ExtensionTerm = 𝓶ap⌶ExtensionFin,ExtensionTerm

-- -- -- -- -- --       Map⌶ExtensionFin,ExtensionTerms : ∀ {N} → Map (Extension Fin) (Extension (Terms N))
-- -- -- -- -- --       Relationality.relationality Map⌶ExtensionFin,ExtensionTerms = 𝓶ap⌶ExtensionFin,ExtensionTerms
